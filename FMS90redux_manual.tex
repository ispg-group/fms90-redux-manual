...
This section provides an overview of the basic FMS program flow for AIMS dynamics. The reader is assumed to be familiar with the fundamental principles of AIMS; see the FMS bibliography (sec. \ref{sec:aimsbiblio}) for a list of references. For details of other calculation types, see section \ref{other}.
...
FMS90 contains a series of (analytical) model systems that can be used for development or to get acquainted with a typical AIMS simulation without the associated electronic-structure costs. The following models are implemented:
