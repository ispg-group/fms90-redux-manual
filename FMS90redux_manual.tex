...
%2 INTRO
OpenFMS90 implements the Ab Initio Multiple Spawning (AIMS) method to perform dynamics 
...
If you have any comments or additions for this manual, please open an issues on the GitHub repository of OpenFMS90 (\url{https://github.com/ispg-group/fms90-redux/tree/main}).

\newpage \section{Building OpenFMS90}
\label{build}

To compile OpenFMS90, please follow the up-to-date instructions that can be found on the GitHub page of the code: \url{https://github.com/ispg-group/fms90-redux/tree/main}.
...
This section provides an overview of the basic OpenFMS90 program flow for AIMS dynamics. The reader is assumed to be familiar with the fundamental principles of AIMS; see the OpenFMS90 bibliography (sec. \ref{sec:aimsbiblio}) for a list of references. 
...
Prior to the beginning of AIMS dynamics, initial conditions may be generated from an adequate ground-state distribution. OpenFMS90 provides a variety of sampling methods, depending on the system type. Alternatively, initial coordinates and momenta may be specified manually in Geometry.dat (sec. \ref{geomdat}).
...
\subsection{OpenFMS90-Terachem}
\label{fms90tcl} 
Follow the most up-to-date instructions on the GitHub page of OpenFMS90: \url{https://github.com/ispg-group/fms90-redux/tree/main}.
...
OpenFMS90 contains a series of (analytical) model systems that can be used for development or to get acquainted with a typical AIMS simulation without the associated electronic-structure costs. The desired model is selected with the keyword gliModel. The following models are implemented:
...
The model systems are used as a test set for OpenFMS90.
